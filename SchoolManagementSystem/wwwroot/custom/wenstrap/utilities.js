...
function successDialog(successMsg, successTitle, callback) {
    var strContent = '<div><img src="/Contents/images/success.png"><span>' + successMsg + '</span></div>';
    $('<span id="win" />') 
        .kendoWindow({  
            title: successTitle,
            modal: true,
...
function warningDialog(warningMsg, warningTitle, callback) {
    var strContent = '<div><img src="/Contents/images/success.png"><span>' + warningMsg + '</span></div>';
    $('<span id="win" />')
        .kendoWindow({ 
            title: warningTitle,
            modal: true, 
